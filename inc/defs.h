 ...
 * The core parameters are closely modeled after Intel Lion Cove architecture.
 *
 ******************************************************************/
...
// Branch predictor
#define BRANCH_MISPREDICT_PENALTY                                              \
  17  // best-case penalty in Golden Cove is 17 cycles
...
// L2 CACHE
#define L2C_SET 4096  // 2.5 MB per-core. Golden Cove server would have 2MB L2
#define L2C_WAY 10
 ...
 * Retire stage *
 ****************/
#define RETIRE_WIDTH 12

/****************
 * Main memory *
 ****************/
#define DRAM_CHANNELS                                                          \
  1  // default: assuming one DIMM per one channel 4GB * 1 => 4GB off-chip
     // memory
