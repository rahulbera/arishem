                ...
                const char *value)
{
  ...
  /* next-line */
    ...
    knob::next_line_enable_prefetch_tracking = !strcmp(value, "true") ? true
                                                                      : false;
  ...
  /* Scooby */
    ...
    knob::scooby_enable_reward_out_of_bounds = !strcmp(value, "true") ? true
                                                                      : false;
    ...
    knob::scooby_enable_state_action_stats = !strcmp(value, "true") ? true
                                                                    : false;
  } else if (MATCH("", "scooby_enable_reward_tracker_hit")) {
    knob::scooby_enable_reward_tracker_hit = !strcmp(value, "true") ? true
                                                                    : false;
    ...
    knob::scooby_enable_featurewise_engine = !strcmp(value, "true") ? true
                                                                    : false;
  ...
  /* Featurewise Learning Engine */
    ...
    knob::le_featurewise_enable_action_fallback = !strcmp(value, "true")
                                                    ? true
                                                    : false;
    ...
    knob::le_featurewise_enable_dynamic_weight = !strcmp(value, "true") ? true
                                                                        : false;
    ...
    knob::le_featurewise_selective_update = !strcmp(value, "true") ? true
                                                                   : false;
    ...
    knob::le_featurewise_enable_dyn_action_fallback = !strcmp(value, "true")
                                                        ? true
                                                        : false;
    ...
    knob::le_featurewise_enable_score_plot = !strcmp(value, "true") ? true
                                                                    : false;
    ...
    knob::le_featurewise_remove_plot_script = !strcmp(value, "true") ? true
                                                                     : false;
  }
